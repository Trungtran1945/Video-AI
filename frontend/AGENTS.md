...
> (dịch phụ đề 12 phong cách + lồng tiếng AI tuỳ chọn) nhưng code hiện tại vẫn còn mode cũ
...
- `src/lib/constants.jsx`: nhãn trạng thái, stage pipeline, ngôn ngữ/phong cách dịch (12 preset)/giọng đọc.
...
- Danh mục phong cách dịch: `GET /style-presets` → 12 preset (slug, name, description).
