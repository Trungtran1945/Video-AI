...
| [`docs/05_THIET_KE_PIPELINE_CHI_TIET.md`](docs/05_THIET_KE_PIPELINE_CHI_TIET.md) | Thuật toán Align (giọng khớp cảnh), Forced Alignment, 13 StylePreset, từng stage |
...
- **AI/Provider:** Provider Pattern cho ASR (+ diarization), TTS, Vision/LLM,
